...
public class DebugThirteen2
{
   ...
   {
      Path fileIn =
         Paths.get(System.getProperty("user.dir") + "\\DebuggingExercises\\DebugData3.txt");
      Path fileOut =
         Paths.get(System.getProperty("user.dir") + "\\DebuggingExercises\\DebugData3New.txt");
      String areaCode = "(312) ";
      String phone;
      ...
      try
      {
         ...
         output = new BufferedOutputStream(Files.newOutputStream(fileOut));
